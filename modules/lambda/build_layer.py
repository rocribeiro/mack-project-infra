#!/usr/bin/env python3
"""Build a Lambda layer package (zip) from a requirements.txt file.

This is used from Terraform via the external data source.

Input (JSON via stdin):
  {
    "build_dir": "/abs/path/to/_layer_build",
    "requirements": "/abs/path/to/requirements.txt",
    "output_zip": "/abs/path/to/lambda_layer.zip",
    "python_version": "3.12"
  }

Output (JSON to stdout):
  {"zip_path": "/abs/path/to/lambda_layer.zip"}
"""
