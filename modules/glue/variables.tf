...
variable "s3_bucket_sor"      { type = string }
variable "s3_bucket_sot"      { type = string }
variable "s3_bucket_spec"     { type = string }
...
variable "glue_max_retries"   { type = number; default = 1 }
